...
public class ProjectControllerTest {
    ...
    public void createProject_ReturnCreated() throws Exception {
        ...
        response.andExpect(MockMvcResultMatchers.status().isOk())
                ...
                .andExpect(
                        MockMvcResultMatchers.jsonPath("$.result.language").value(projectCreateRequest.getLanguage()))
                .andExpect(MockMvcResultMatchers.jsonPath("$.result.status")
                        .value(projectCreateRequest.getStatus().name()));
    }
    ...
    public void deleteProject_ReturnOk() throws Exception {
        ...
        ResultActions response =
                mockMvc.perform(delete("/project/{id}", projectId).contentType(MediaType.APPLICATION_JSON));
    ...
    public void getAll_ReturnProjectList() throws Exception {
        ...
        ResultActions response = mockMvc.perform(get("/project").contentType(MediaType.APPLICATION_JSON));
        ...
        response.andExpect(MockMvcResultMatchers.status().isOk())
                ...
                .andExpect(
                        MockMvcResultMatchers.jsonPath("$.result[0].language").value(projectResponse.getLanguage()))
                .andExpect(MockMvcResultMatchers.jsonPath("$.result[0].status")
                        .value(projectResponse.getStatus().name()));
    }
