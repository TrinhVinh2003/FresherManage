...
public class UserController {
    ...
    @PostMapping
    ApiResponse<UserResponse> createUser(@RequestBody @Valid UserCreationRequest request){   // @valid validate object dựa theo những cái role mà đc defind trong object đó
